...
_io = [
    ...
    ("spisdcard", 0,
        ...
        Subsignal("mosi", Pins("J8"), Misc("PULLUP True")),
        Subsignal("cs_n", Pins("J6"), Misc("PULLUP True")),
        Subsignal("miso", Pins("M5"), Misc("PULLUP True")),
        Misc("SLEW=FAST"),
        IOStandard("LVCMOS33"),
    ),
    ("sdcard", 0,
        Subsignal("data", Pins("M5 M7 H6 J6"), Misc("PULLUP True")),
        Subsignal("cmd",  Pins("J8"),          Misc("PULLUP True")),
        Subsignal("clk",  Pins("L4")),
    ...
    # USB PS/2
    ("usbhost", 0,
       Subsignal("ps2_clk", Pins("D6")),
       Subsignal("ps2_data", Pins("G6")),
       IOStandard("LVCMOS33")
    )
...
#        ("ps2kbd", 0, Pins(f"{pmod}:0 {pmod}:2"), IOStandard("LVCMOS33")), # data, clk
        ("ps2kbd", 0, Pins(f"{pmod}:3 {pmod}:2"), IOStandard("LVCMOS33")), # data, clk
]
