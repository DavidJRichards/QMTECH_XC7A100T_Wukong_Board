...
class BaseSoC(SoCCore):
    def __init__(self, sys_clk_freq=int(100e6), with_ethernet=False, with_etherbone=False,
                 eth_ip="192.168.178.250", with_led_chaser=True, with_video_terminal=False,
#                 with_video_framebuffer=False, video_timing="640x480@60Hz", **kwargs):
                 with_video_framebuffer=False, video_timing="800x600@60Hz", **kwargs):
#                 with_video_framebuffer=False, video_timing="1024x768@60Hz", **kwargs):
...
#        soc.platform.add_extension(qmtech_wukong._sdcard_pmod_io)
    ...
    soc.platform.add_extension(qmtech_wukong._ps2_pmod_io)
